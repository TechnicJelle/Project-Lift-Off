...
// Channel
	...
	// Spectrum // can also be done in System for total output, not tested yet
		[DllImport("../../GXPEngine/lib/fmodex.dll", EntryPoint="FMOD_Channel_GetSpectrum")]
	...
	// Volume
		[DllImport("../../GXPEngine/lib/fmodex.dll", EntryPoint="FMOD_Channel_GetVolume")]
		public static extern void Channel_GetVolume( uint channel, out float volume );

		[DllImport("../../GXPEngine/lib/fmodex.dll", EntryPoint="FMOD_Channel_SetVolume")]
